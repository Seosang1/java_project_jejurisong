...
<div class="contents">
	...
	<button type="button" class="btn btn-dark btn-lg" style="width:100%;text-align:left;">음식점 후기 작성</button>
		...
		<div class="col-md-12" style="font-size: 14px;">
			<div class="row g-0 border rounded overflow-hidden flex-md-row shadow-sm h-md-250 position-relative" style="padding:20px;">
				<div class="col-auto d-none d-lg-block" style="margin-top: 30px;margin-left: 20px;">
					<img src="<%=foodImgSrc %><%=info.getFood_img1() %>" width="400px;" />
					<h5 style="margin-top:10px;text-align:center;"><%=info.getFood_name()%></h5>
					<h6 style="margin-top:10px;text-align:center;"><%=info.getFood_addr()%></h6>
				</div>
				<div class="col p-4 d-flex flex-column position-static">
					<!-- 예약정보 입력 -->
					<div class="col-md-8 col-lg-11">
						<form class="needs-validation" novalidate name="frm" method="post" action="food_reply_proc.food" style="margin-left:30px;width:100%">
							<input type="hidden" name="hd_food_code" value="<%=info.getFood_code()%>" />
