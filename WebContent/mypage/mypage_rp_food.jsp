...
.profile {
	...
	<div class="contents" style="padding:0px;">
		<h4 style="margin-top:25px;margin-left:10px;">내가 작성한 음식점 후기</h4>
		<div class="my-3 p-3 bg-body rounded shadow-sm" style="display: flex;flex-wrap: wrap;"> 
			...
			<div class="card" style="margin-right: 10px;width: 48%;margin:10px;padding:10px;">
				<div class="card-body">
					<p><a href="food_view.tour?food_code=<%=info.getFood_code() %>"><%=info.getFood_name() %></a></p>
		...
		%>
			...
			<div class="card" style="margin-right: 10px;width: 100%;margin:10px;padding:10px;">
				<div class="card-body">
